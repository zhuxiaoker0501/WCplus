...
# Embedded file name: app\l1ll11ll1_wcplus_\l1ll1l1l1_wcplus_\prepare_data_for_front_end.py
"""
阅读数据爬虫
"""
import requests
...
from utils.string_handle import string2Dict, dict2String, updateDictValue
import time
...
class l11lll1l1l_wcplus_:
    ...
    def l11llll1ll_wcplus_(self):
        ...
        l11l1lll11_wcplus_ = string2Dict(self.url.split('?')[1], '&', '=')
        l11ll11111_wcplus_ = string2Dict(rd['requestData'], '&', '=')
        l11ll1111l_wcplus_ = self.l11l1lllll_wcplus_(l11l1lll11_wcplus_)
        l11ll11111_wcplus_['is_need_reward'] = 1
        updateDictValue(l11ll11111_wcplus_, l11ll1111l_wcplus_, ['mid', 'sn', 'idx', 'scene'])
        l11ll11111_wcplus_['comment_id'] = self.comment_id
        l11ll11111_wcplus_['is_need_reward'] = 1
        self.req['url'] = rd['url']
        self.req['body'] = dict2String(l11ll11111_wcplus_)
